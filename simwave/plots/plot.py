...
def plot_shotrecord(rec, file_name="shotrecord", colorbar=True,
                    show=False, solver=None, dirname=None):
    """
    ...
    # create the destination dir
    if dirname is None: dirname = "plots"
    os.makedirs(dirname, exist_ok=True)
    plt.savefig(dirname+"/{}.png".format(file_name), format="png")
    ...
    print("Shot record saved in {}/{}.png".format(dirname, file_name))


def plot_velocity_model(model, sources=None, receivers=None,
                        file_name="velocity_model", colorbar=True,
                        solver=None, cmap="jet", show=False, dirname=None):
    """
    ...
    print("Velocity model saved in {}/{}.png".format(dirname, file_name))
